...
pub async fn list(
    ...
    client.paginate_v3("projects/", params, limit).await
}
...
pub async fn create(client: &RestClient, body: &Value) -> Result<Value> {
    client.post_v3("projects/", body).await
}

pub async fn update(client: &RestClient, project_id: u64, body: &Value) -> Result<Value> {
    client
        .post_v3(&format!("projects/{project_id}/"), body)
        .await
}
