...
#[derive(Debug, Args)]
pub struct SemanticModelsArgs {
    #[command(subcommand)]
    pub command: SemanticModelsCommand,
}

#[derive(Debug, Subcommand)]
pub enum SemanticModelsCommand {
    /// Show detailed semantic model information
    Show {
        /// Semantic model name or unique_id
        identifier: String,
    },
}

pub async fn exec(
    args: &SemanticModelsArgs,
    ...
    match &args.command {
        SemanticModelsCommand::Show { identifier } => {
